...
public class Estoque {
    ...
    //public static void findPeca(String cdpeca) throws Exception{
    //    Estoque nomePeca = null;
    //    Connection con = AppListener.getConnection();
    //    String sql = "SELECT nomepeca from pecas WHERE cdpeca=?";
    //    PreparedStatement stmt = con.prepareStatement(sql);
     //   stmt.setString(1, cdpeca);
     //   ResultSet rs = stmt.executeQuery();
     //   if(rs.next()){
     //       long rowId = rs.getLong("rowid");
      //      cdpeca = rs.getString("nomepeca");
     //       nomePeca = new Pecas();
     //   }
     //   rs.close();
     //   stmt.close();
